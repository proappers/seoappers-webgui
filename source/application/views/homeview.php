        ...
        <div class="span9">
          ...
          <div class="hero-unit">
			...
			<div class="span2" style="margin: 0;">
				Dauer: <?php $dauer = datediff($active_crawl[0]->date_started, $active_crawl[0]->date_finished); echo $dauer['hour'].' Stunden '.$dauer['minute'].' Minuten '.$dauer['second'].' Sekunden'; ?><br />
